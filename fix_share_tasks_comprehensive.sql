-- Comprehensive Fix for Share Tasks Functionality
-- This script addresses common issues with task sharing
...
-- 2. Create a robust share_task_with_friend function
...
-- 3. Create a function to remove friend from shared task
...
-- 4. Create a function to get shared friends for a task
...
BEGIN
  ...
  RAISE NOTICE 'Testing share tasks functions...';
