-- =====================================================
-- FIX SHARED EVENTS - CORRECTED VERSION
-- =====================================================
-- This script fixes the shared events issue by adding the missing event_data column
-- and handling the photos column data type correctly

-- 1. Add the missing event_data column to shared_events table
...
-- Fixed the photos column data type issue
