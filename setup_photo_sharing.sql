-- Complete setup for photo sharing functionality
-- Run this in the Supabase SQL Editor

-- 1. Update the social_updates table to allow photo_share type
...
-- 2. Add photo sharing columns if they don't exist
ALTER TABLE public.social_updates 
...
-- 4. Update the policy to allow viewing friends' photo shares
...
-- 5. Create function to get friends' photo shares
