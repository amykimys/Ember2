-- Fix Friends Feed Function
-- This script updates the get_friends_photo_shares function to the latest version

-- Drop the existing function
DROP FUNCTION IF EXISTS public.get_friends_photo_shares(current_user_id uuid, limit_count integer);

-- Create the updated function that includes own photos and fixes any issues
