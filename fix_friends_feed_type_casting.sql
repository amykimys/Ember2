-- Fix Friends Feed Type Casting Issue
-- This script fixes the UUID type casting problem in the friends feed function
...
-- Show what we have in social_updates
