-- Safe migration fix for user_preferences table
-- This script handles data type conversion properly
...
-- Step 1: Create a proper backup with explicit column selection
...
-- Step 8: Restore data from backup with proper handling
...
SELECT 
  ...
  created_at,
  updated_at,
  false as auto_move_uncompleted_tasks  -- Add default value for new column
