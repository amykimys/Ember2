-- Events-Only Friends Feed Photo Sharing Test
-- This script works with your existing users and creates test photo shares for events only
...
-- Step 3: Create test photo shares for events only
...
-- Step 4: Test the friends feed function for user1
...
-- Step 5: Show all created social updates
...
-- Step 6: Show the events created
...
-- Step 7: Clean up test data (uncomment to remove)
-- DELETE FROM social_updates WHERE source_id LIKE 'test-event-%';
